...
/**
 * This is a codelab sample app for Workmanager API.
 *
 * The url for this codelab is -https://developer.android.com/codelabs/android-workmanager#0
 *
 * In this codelab i covered following topics -
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.outputWorkInfos.observe(this, Observer {
            ...
            run {
                ...
                if (listWorksInfo.isNullOrEmpty()) {
                    return@Observer
                }

                // We only care about the one output status.
                // Every continuation has only one worker tagged TAG_OUTPUT
                val workInfo = listWorksInfo[0]
                ...
                if (workInfo.state.isFinished) {
                    ...
                    //Note how i have used workInfo.outputData to get output data of the worker saveImageToFile.
